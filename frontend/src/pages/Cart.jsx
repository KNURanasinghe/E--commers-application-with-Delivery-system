      ...
      <div>
        {
          cartData.map((item, index)=>{
            ...
            return (
             <div className='py-4 border-b border-t  text-gray-700 grid grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
              ...
              <input onChange={(e)=> e.target.value === '' || e.target.value === '0'? null: updateQuantity(item._id, item.size, Number(e.target.value))} className='px-1 py-2 border max-w-10 sm:max-w-20 sm:px2' type="number" min={1} defaultValue={item.quantity} />
